...
class BinaryOperatorConstructions(Construction):
    ...
    OPERATORS = {'EQU': {'latex': '%s = %s', 'priority': 0, 'associative': True, 'weak': False, 'nobrackets': True},
                 ...
                 'IDX': {'latex': '{%s}_{%s}', 'priority' : 4, 'associative': False, 'weak': False, 'nobrackets': False},
                 'CMA': {'latex': '%s,%s', 'priority': 0, 'associative': True, 'weak': False, 'nobrackets': False},
                 'SCN': {'latex': '%s;%s', 'priority': 0, 'associative': True, 'weak': False, 'nobrackets': False},
                 'PIR': {'latex': '\\left( %s, %s \\right)', 'priority': 0, 'associative': False, 'weak': False, 'nobrackets': True},
                 }
